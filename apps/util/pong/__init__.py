import pygame, pygame_gui;from pygame_gui.elements.ui_window import UIWindow;from pygame_gui.elements.ui_image import UIImage;from pygame.locals import *;import math;import random
class Score:
